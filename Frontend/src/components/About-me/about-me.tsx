    ...
    <>
      ...
      >
        ...
        <img
          src="/pfp.png"
          alt="Pfp Img"
          className="w-40 h-40 md:w-[15rem] md:h-[15rem] xl:w-[20rem] xl:h-[20rem] 2xl:h-[33rem] 2xl:w-[33rem] rounded-full"
        ></img>
        {/* About me */}
        <div className="mx-auto text-gray-200  text-center">
          ...
          <a href="/resume.pdf" download className="block mt-4 2xl:mt-6">
            <button
              className="bg-blue-500 text-white py-2 xl:py-4 2xl:py-6 px-6 xl:px-7 2xl:px-10 xl:text-2xl 2xl:text-4xl rounded-md transition-all duration-1000 lg:hover:bg-blue-600 
