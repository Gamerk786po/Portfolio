  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center p-3 bg-slate-800 rounded-xl">
      ...
      <div className="flex flex-row p-1 mx-1">
        <img
          className="h-7 w-11 xl:h-9 xl:w-13
         px-3"
          src={url}
          alt={alt}
        ></img>
      ...
      <p className="text-[12px] md:text-[14px] xl:text-[22px] text-slate-300 tracking-tighter md:tracking-tight xl:tracking-wide 2xl:tracking-wider">{description}</p>
    </div>
  );
};
